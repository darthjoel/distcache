...
public class ProductCatalog {
	private final HashMap<String,List<Product>> cache;

	public ProductCatalog() {
		cache = new HashMap<String,List<Product>>();
	}
	...
	private List<Product> initCatalog() {
		...
		cache.put("cameras", catalog);
		return catalog;
	}

	@SuppressWarnings("unchecked")
	public List<Product> getCatalog() {
		List<Product> cachedCameras = cache.get("cameras");

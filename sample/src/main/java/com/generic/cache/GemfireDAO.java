...
import com.gemstone.gemfire.tutorial.storage.LoggingCacheListener;
/**
 ...
 */
public class GemfireDAO implements CacheDAO{
  
  private Region<String,Profile> people;
  private Region<String,Object> session;
  private Region<PostID, String> posts;
  private boolean isClient;
  private static GemfireDAO dao = null;

  public static GemfireDAO getDAO(){
	if ( dao == null ){
		dao = new GemfireDAO();
		dao.initClient(); 
	}
  ...
  public void initPeer() {
    ...
    //from a peer
    session = cache.<String, Object>createRegionFactory(REPLICATE)
  ...
  public void initClient() {
    ...
    session = cache.<String, Object>createClientRegionFactory(PROXY)
      .create("session");
